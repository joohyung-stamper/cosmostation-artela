module github.com/cosmostation/cosmostation-coreum

go 1.20

require github.com/CoreumFoundation/coreum/v3 v3.0.2
...
require (
	github.com/cosmostation/mintscan-backend-library v0.0.0-20230601142615-28bc571a5b0c //sdk-0.47.x
	github.com/cosmostation/mintscan-database v1.1.5
)
